...
static constexpr DecoderListEntry DecoderList32[]{
    ...
    {DecoderTablevfwdotp32, {RISCV::FeatureVendorXvfwdotp}, "PULP Xvfwdotp extensions"},
    {DecoderTablevfx32, {RISCV::FeatureVendorXvfx}, "PULP Xvfx extensions"},
    ...
    {DecoderTablefrep32, {RISCV::FeatureVendorXfrep}, "PULP Xfrep extensions"},
    {DecoderTableipu32, {RISCV::FeatureVendorXipu}, "PULP Xipu extensions"},
    {DecoderTablepulpabs32, {RISCV::FeatureVendorXpulpabs}, "PULP Xpulpabs extensions"},
    {DecoderTablepulpbitop32, {RISCV::FeatureVendorXpulpbitop}, "PULP Xpulpbitop extensions"},
    {DecoderTablepulpbr32, {RISCV::FeatureVendorXpulpbr}, "PULP Xpulpbr extensions"},
    {DecoderTablepulpclip32, {RISCV::FeatureVendorXpulpclip}, "PULP Xpulpclip extensions"},
    {DecoderTablepulpmacsi32, {RISCV::FeatureVendorXpulpmacsi}, "PULP Xpulpmacsi extensions"},
    {DecoderTablepulpminmax32, {RISCV::FeatureVendorXpulpminmax}, "PULP Xpulpminmax extensions"},
    {DecoderTablepulpslet32, {RISCV::FeatureVendorXpulpslet}, "PULP Xpulpslet extensions"},
    {DecoderTablepulpvectshufflepack32, {RISCV::FeatureVendorXpulpvectshufflepack}, "PULP Xpulpvectshufflepack extensions"},
    {DecoderTablepulpvect32, {RISCV::FeatureVendorXpulpvect}, "PULP Xpulpvect extensions"},
    {DecoderTablesmallfloat_b32, {RISCV::FeatureVendorXsmallfloatB}, "PULP Xsmallfloat_b extensions"},
    {DecoderTablesmallfloat_h32, {RISCV::FeatureVendorXsmallfloatH}, "PULP Xsmallfloat_h extensions"},
    {DecoderTablesmallfloat_vb32, {RISCV::FeatureVendorXsmallfloatVb}, "PULP Xsmallfloat_vb extensions"},
    {DecoderTablesmallfloat_vh32, {RISCV::FeatureVendorXsmallfloatVh}, "PULP Xsmallfloat_vh extensions"},
    {DecoderTablesmallfloat_vs32, {RISCV::FeatureVendorXsmallfloatVs}, "PULP Xsmallfloat_vs extensions"},
    {DecoderTablessr32, {RISCV::FeatureVendorXssr}, "PULP Xssr extensions"},
    // Standard Extensions
